...
class ExampleCapture {
  static render(int width, int height) {
    ...
    var outputAttachment = texture.createView(
        GPUTextureViewDescriptor(format: GPUTextureFormat.Undefined));
    ...
    var renderPass = encoder
        .beginRenderPass(GPURenderPassDescriptor(colorAttachments: attach));
    renderPass.end();
