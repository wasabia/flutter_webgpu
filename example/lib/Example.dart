...
void wgpuRequestAdapterCallback(int status, WGPUAdapter received, Pointer<Int8> message,
            Pointer<Void> userdata) {
  print("wgpuRequestAdapterCallback  status: ${status} received: ${received} message: ${message} userdata: ${userdata} ");
...
class Example {
  ...
  static initWebGPU() {
    ...
    _webGPU.wgpuInstanceRequestAdapter(nullptr, options, adapterCallback, adapter.cast<Void>());
    ...
    Pointer<WGPUDeviceDescriptor> descriptor = ffi.calloc<WGPUDeviceDescriptor>();
    ...
    _desc.usage = WGPUBufferUsage.WGPUBufferUsage_MapRead | WGPUBufferUsage.WGPUBufferUsage_CopyDst;
    _desc.size = bufferSize;
    _desc.mappedAtCreation = 0;

    WGPUBuffer outputBuffer = _webGPU.wgpuDeviceCreateBuffer(device.value, desc);
    ...
    _desc2.usage = WGPUTextureUsage.WGPUTextureUsage_RenderAttachment | WGPUTextureUsage.WGPUTextureUsage_CopySrc;

    WGPUTexture texture = _webGPU.wgpuDeviceCreateTexture(device.value, desc2);


    Pointer<WGPUCommandEncoderDescriptor> desc3 = ffi.calloc<WGPUCommandEncoderDescriptor>();
    WGPUCommandEncoderDescriptor _desc3 = desc3.ref;
    _desc3.label = nullptr;
    WGPUCommandEncoder encoder = _webGPU.wgpuDeviceCreateCommandEncoder(device.value, desc3);


    Pointer<WGPUTextureViewDescriptor> desc4 = ffi.calloc<WGPUTextureViewDescriptor>();
    ...
    _desc4.dimension = WGPUTextureViewDimension.WGPUTextureViewDimension_Undefined;
    ...
    WGPUTextureView outputAttachment = _webGPU.wgpuTextureCreateView(texture, desc4);
    ...
    Pointer<WGPURenderPassColorAttachment> attach = ffi.calloc<WGPURenderPassColorAttachment>();
    ...
    Pointer<WGPUImageCopyTexture> copyTexture = ffi.calloc<WGPUImageCopyTexture>();
    ...
    Pointer<WGPUCommandBufferDescriptor> desc6 = ffi.calloc<WGPUCommandBufferDescriptor>();
    WGPUCommandBufferDescriptor _desc6 = desc6.ref;
    _desc6.label = nullptr;

    WGPUCommandBuffer cmdBuffer = _webGPU.wgpuCommandEncoderFinish(encoder, desc6);
    Pointer<WGPUCommandBuffer> cmdBufferPointer = ffi.calloc<WGPUCommandBuffer>();
