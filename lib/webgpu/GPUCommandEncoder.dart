...
class GPUCommandEncoder extends GPUObjectBase {
  ...
  GPURenderPassEncoder beginRenderPass(GPURenderPassDescriptor descriptor) {
    WGPURenderPassEncoder renderPass = Wgpu.binding
        .wgpuCommandEncoderBeginRenderPass(encoder, descriptor.pointer);
  ...
  GPUComputePassEncoder beginComputePass(
    ...
    WGPUComputePassEncoder computePass = Wgpu.binding
  ...
  void copyBufferToBuffer(GPUBuffer source, int sourceOffset,
    ...
    Wgpu.binding.wgpuCommandEncoderCopyBufferToBuffer(encoder, source.buffer,
        sourceOffset, destination.buffer, destinationOffset, size);
  }

  GPUCommandBuffer finish([GPUCommandBufferDescriptor? descriptor]) {
    WGPUCommandBuffer buffer = Wgpu.binding
        .wgpuCommandEncoderFinish(encoder, descriptor?.pointer ?? nullptr);
...
class GPURenderPassColorAttachment {
  ...
  GPURenderPassColorAttachment.pointer(
      Pointer<WGPURenderPassColorAttachment> pointer) {
