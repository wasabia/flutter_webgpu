...
final int WGPUSType_ShaderModuleWGSLDescriptor = WGPUSType.WGPUSType_ShaderModuleWGSLDescriptor;

final int WGPUPrimitiveTopology_TriangleList = WGPUPrimitiveTopology.WGPUPrimitiveTopology_TriangleList;
...
final int WGPUTextureSampleType_Undefined = WGPUTextureSampleType.WGPUTextureSampleType_Undefined;

final int WGPUStorageTextureAccess_Undefined = WGPUStorageTextureAccess.WGPUStorageTextureAccess_Undefined;



class GPUPowerPreference {
  static const int Undefined = WGPUPowerPreference.WGPUPowerPreference_Undefined;
  static const int LowPower = WGPUPowerPreference.WGPUPowerPreference_LowPower;
  static const int HighPerformance = WGPUPowerPreference.WGPUPowerPreference_HighPerformance;
...
class GPUTextureFormat {
  ...
  static const int RGBA8UnormSrgb = WGPUTextureFormat.WGPUTextureFormat_RGBA8UnormSrgb;
  static const int Depth24PlusStencil8 = WGPUTextureFormat.WGPUTextureFormat_Depth24PlusStencil8;

  static const int Depth24Plus = WGPUTextureFormat.WGPUTextureFormat_Depth24Plus;

  static const int BC1RGBAUnorm = WGPUTextureFormat.WGPUTextureFormat_BC1RGBAUnorm;
  static const int BC1RGBAUnormSRGB = WGPUTextureFormat.WGPUTextureFormat_BC1RGBAUnormSrgb;
  static const int BC2RGBAUnorm = WGPUTextureFormat.WGPUTextureFormat_BC2RGBAUnorm;
  static const int BC2RGBAUnormSRGB = WGPUTextureFormat.WGPUTextureFormat_BC2RGBAUnormSrgb;
  static const int BC3RGBAUnorm = WGPUTextureFormat.WGPUTextureFormat_BC3RGBAUnorm;
  static const int BC3RGBAUnormSRGB = WGPUTextureFormat.WGPUTextureFormat_BC3RGBAUnormSrgb;
  ...
  static const int BC6HRGBUFloat = WGPUTextureFormat.WGPUTextureFormat_BC6HRGBUfloat;
  static const int BC7RGBAUnorm = WGPUTextureFormat.WGPUTextureFormat_BC7RGBAUnorm;
  static const int BC5RGSnorm = WGPUTextureFormat.WGPUTextureFormat_BC5RGSnorm;

  static const int BC6HRGBFloat = WGPUTextureFormat.WGPUTextureFormat_BC6HRGBFloat;
  static const int BC7RGBAUnormSRGB = WGPUTextureFormat.WGPUTextureFormat_BC7RGBAUnormSrgb;
  ...
  static const int RGBA16Float = WGPUTextureFormat.WGPUTextureFormat_RGBA16Float;
  static const int RGBA32Float = WGPUTextureFormat.WGPUTextureFormat_RGBA32Float;
...
class GPUTextureUsage {
  static const int RenderAttachment = WGPUTextureUsage.WGPUTextureUsage_RenderAttachment;
  static const int TextureBinding = WGPUTextureUsage.WGPUTextureUsage_TextureBinding;
...
class GPUStencilOperation {
  ...
  static const int DecrementWrap = WGPUStencilOperation.WGPUStencilOperation_DecrementWrap;
  static const int IncrementWrap = WGPUStencilOperation.WGPUStencilOperation_IncrementWrap;
  static const int IncrementClamp = WGPUStencilOperation.WGPUStencilOperation_IncrementClamp;
  static const int DecrementClamp = WGPUStencilOperation.WGPUStencilOperation_DecrementClamp;
...
class GPUCompareFunction {
  ...
  static const int GreaterEqual = WGPUCompareFunction.WGPUCompareFunction_GreaterEqual;
  static const int Equal = WGPUCompareFunction.WGPUCompareFunction_Equal;
  static const int LessEqual = WGPUCompareFunction.WGPUCompareFunction_LessEqual;
...
class GPUPrimitiveTopology {
  ...
  static const int TriangleList = WGPUPrimitiveTopology.WGPUPrimitiveTopology_TriangleList;
  static const int PointList = WGPUPrimitiveTopology.WGPUPrimitiveTopology_PointList;
  static const int LineList = WGPUPrimitiveTopology.WGPUPrimitiveTopology_LineList;
  static const int LineStrip = WGPUPrimitiveTopology.WGPUPrimitiveTopology_LineStrip;
  static const int TriangleStrip = WGPUPrimitiveTopology.WGPUPrimitiveTopology_TriangleStrip;
...
class GPUBlendFactor {
  ...
  static const int OneMinusSrcAlpha = WGPUBlendFactor.WGPUBlendFactor_OneMinusSrcAlpha;
  static const int OneMinusSrcColor = WGPUBlendFactor.WGPUBlendFactor_OneMinusSrc;

  static const int OneMinusDstColor = WGPUBlendFactor.WGPUBlendFactor_OneMinusSrc;
  static const int OneMinusDstAlpha = WGPUBlendFactor.WGPUBlendFactor_OneMinusDstAlpha;
  ...
  static const int SrcAlphaSaturated = WGPUBlendFactor.WGPUBlendFactor_SrcAlphaSaturated;
...
class GPUBlendOperation {
  ...
  static const int ReverseSubtract = WGPUBlendOperation.WGPUBlendOperation_ReverseSubtract;
...
class GPUTextureViewDimension {
  static const int Undefined = WGPUTextureViewDimension.WGPUTextureViewDimension_Undefined;
